...
tests first, then write some code until the compiler stops screaming at me,
then write even more code until I get that glorious green checkmark on the last
line of the output of `swift test`. Rinse and repeat.
